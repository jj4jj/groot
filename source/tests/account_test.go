...
func TestLoginOrRegisterGetSmsCode(t *testing.T) {

	req := csmsg.CSMsgAccountLoginOrRegisterGetSmsCodeReq{
		Tel:  "15102991436",
	}
	var rsp csmsg.CSMsgAccountLoginOrRegisterGetSmsCodeRsp
	err := MainServer.Call("account.login_or_register_get_sms_code", &req, &rsp)
	if err != nil {
		t.Error(err)
	}
	//ok
...
func TestLoginOrRegisterConfirm(t *testing.T) {
	req := csmsg.CSMsgAccountLoginOrRegisterReq{
	...
	var rsp csmsg.CSMsgAccountLoginOrRegisterRsp
	err := MainServer.Call("account.login_or_register", &req, &rsp)
	if err != nil {
		t.Error(err)
	}
	//ok
...
func TestLoginOrRegisterAll(t *testing.T) {
